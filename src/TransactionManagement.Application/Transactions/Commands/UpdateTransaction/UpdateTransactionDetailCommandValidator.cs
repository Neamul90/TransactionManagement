...
public sealed class UpdateTransactionDetailCommandValidator
    : AbstractValidator<UpdateTransactionDetailCommand>
{
    public UpdateTransactionDetailCommandValidator()
    {
        RuleFor(detail => detail.Id)
            .GreaterThanOrEqualTo(0)
            .WithMessage("The detail line reference is not valid.");
