...
/// <summary>
/// Model for the shared master-detail grid partial, so the create and edit screens render exactly
/// the same grid and the row markup exists in exactly one file.
/// </summary>
